...
void initState() {
super.initState();
Future.microtask(() => context.read<DayProvider>().init());
}
              ...
              Column(
                ...
                children: [
                  Wrap(
                    spacing: 8,
                    runSpacing: 8,
                    children: prov.today!.values.map((kv) {
                      ...
                      return Chip(
                        ...
                        backgroundColor: Color(emo.color).withOpacity(0.12),
                        side: BorderSide(color: Color(emo.color).withOpacity(0.5)),
                      );
                    }).toList(),
                  ),
